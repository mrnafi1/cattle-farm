...
import { useAuth } from "../../contexts/AuthContext"; // পাথটি আপনার ফোল্ডার অনুযায়ী ঠিক করে নিবেন
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          {/* ── এখানে ইমোজির বদলে আপনার লোগো বসানো হয়েছে ── */}
          <div className="w-20 h-20 bg-amber-500/10 text-amber-500 rounded-full flex items-center justify-center mx-auto mb-4 border border-amber-500/20 overflow-hidden p-2">
            <img src="/icons/logo-512.png" alt="Baqarah Agro Logo" className="w-full h-full object-contain drop-shadow-lg" />
          </div>
